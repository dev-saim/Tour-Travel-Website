...
<body>
    ...
    <header class="header">
        ...
        <nav class="navbar">
            ...
            <a href="book.php" style="color:#e67e22" class="active-page">Book</a>
        </nav>
    ...
    <div class="heading" style="background:url(assests/images/banner/3.jpg) no-repeat"> 
        ...
        <form action="book_form.php" method="post" class="book-form">
            ...
            <div class="flex">
                ...
                <div class="input-box">
                    ...
                    <input type="text" placeholder="Total number of travelers" name="guests" required> 
                </div>
